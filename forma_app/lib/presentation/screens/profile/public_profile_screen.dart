...
class _PublicProfileScreenState extends State<PublicProfileScreen> {
          ...
          children: [
            ...
            TextField(
              ...
              decoration: const InputDecoration(
                ...
                hintText: 'Enter notes (e.g. strong left foot, fast sprinter)...',
              ),
            ),
          ],
        ),
  ...
  Widget build(BuildContext context) {
    ...
    final isScout = authState is AuthAuthenticated && authState.user.role == 'scout';

    return Scaffold(
      appBar: AppBar(
        title: const Text('Athlete Portfolio'),
      ),
        ...
        builder: (context, state) {
          ...
          if (state is PublicProfileLoaded) {
            ...
            return RefreshIndicator(
              onRefresh: () async {
                await context.read<PublicProfileCubit>().loadProfile(widget.userId);
              },
                        ...
                        child: Padding(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              if (isScout) ...[
                                ElevatedButton.icon(
                                  onPressed: () => _showShortlistDialog(context, profile.isShortlisted),
                                  style: ElevatedButton.styleFrom(
                                    backgroundColor: profile.isShortlisted ? AppTheme.surface : AppTheme.primary,
                                    foregroundColor: profile.isShortlisted ? AppTheme.textPrimary : Colors.white,
                                  ...
                                  label: Text(profile.isShortlisted ? 'SHORTLISTED' : 'ADD TO SHORTLIST'),
                                ),
                              ],
                            ],
                          ),
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            const SizedBox(height: 8),
                            ...profile.playerProfiles.map((p) => Card(
